...
<!-- This file was taken from http://atom.geekhood.net and was modified a bit to handle Github feeds properly (search for "Github" in this file and see "utils/al-gnus.el" for the verbose explanation. -->
...
<!-- Commented because self link to private feed on Github may contain double dash which is not allowed in comments -->
