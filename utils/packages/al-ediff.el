;;; al-ediff.el --- Additional functionality for `ediff' package  -*- lexical-binding: t -*-
...
;;;###autoload
(defun al/ediff-buffers ()
  "Run Ediff on the current buffers."
  (interactive)
  (ediff-buffers (current-buffer)
                 (window-buffer (next-window))))


;;; Restoring windows after Ediff session
