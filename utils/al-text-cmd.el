...
;;;###autoload (autoload 'al/downcase-word-backward "al-text-cmd" nil t)
;;;###autoload (autoload 'al/capitalize-word-backward "al-text-cmd" nil t)
;;;###autoload (autoload 'al/upcase-word-backward "al-text-cmd" nil t)
